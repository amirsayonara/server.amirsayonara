    ...
    <div id="body-main" role="main">
      <div class="body-content">
        <div class="not-found-404">
          ...
          <h2 class="subheading">Sepertinya kami tidak dapat menemukan halaman yang anda cari. Coba kembali pada halaman sebelumnya atau kunjungi Halaman Awal kami.</h2>
          <span class="not-found-cta"><a href="/" title="Pergi Ke Halaman Awal">Halaman Awal</a></span>
        </div>
      </div>
    </div>
    <script type="text/javascript">!function(){"use strict";!function(){var t=document.getElementById("scope-joint"),e=document.getElementById("telescopeScope"),n=document.getElementById("stars"),i=document.querySelectorAll(".star");e.className+=" animating ",n.className+=" animating ",i.forEach(function(t){var e=Math.floor(9*Math.random()),n="";n=e>=0&&e<3?"slow":e>=3&&e<6?"medium":"fast";var i=t.getAttribute("class").split(" ");i.push(n),t.setAttribute("class",i.join(" "))});var o=function(){var n=t.getBoundingClientRect();e.style.transformOrigin=n.left+"px "+n.top+"px"},s=function(t,e,n){n=n||window;var i=!1,o=function(){i||(i=!0,requestAnimationFrame(function(){n.dispatchEvent(new CustomEvent(e)),i=!1}))};n.addEventListener(t,o)};s("resize","optimizedResize"),window.addEventListener("optimizedResize",function(){o()}),o()}()}();</script></body>
</html>